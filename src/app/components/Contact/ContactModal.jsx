...
export default function ContactModal(props){
    ...
    return (
        <div className="bg-black/25 fixed flex h-full w-full top-0 left-0 px-4" onClick={props.closeFunc}>
            <div className="bg-white flex flex-col w-full h-fit my-auto max-h-[700px] mx-auto max-w-[600px] overflow-y-scroll lg:overflow-y-hidden rounded-sm z-30" onClick={(e) => e.stopPropagation()}>
